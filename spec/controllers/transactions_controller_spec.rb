  ...
  describe "GET 'index'" do
    ...
    describe "authenticated" do
      ...
      it "should get transactions for given account" do
        ...
        expect(Projections::Transaction).to receive(:get_account_transactions).with(user, 22331).and_return(transactions)
        get 'index', account_id: 22331, format: :json
