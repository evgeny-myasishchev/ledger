  ...
  RSpec.describe PendingTransactionsController, :type => :controller do
    ...
    describe "routes", :type => :routing do
      ...
      it "routes POST 'adjust-and-approve-transfer'" do
        expect({post: 'pending-transactions/t-110/adjust-and-approve-transfer'}).to route_to controller: 'pending_transactions', action: 'adjust_and_approve_transfer', id: 't-110'
      end
    ...
    describe 'PUT adjust-and-approve-transfer' do
      it 'should dispatch report command' do
        ...
        put :adjust_and_approve_transfer, id: 't-100',
          amount: '222.32', date: date, tag_ids: ['t-1', 't-2'], 
          comment: 'Comment 100', account_id: 'a-100', type_id: nil, receiving_account_id: 'account-100', amount_received: '100.01', format: :json
        expect(response.status).to eql 200
      end
    end
