...
describe Application::Commands::LedgerCommands do
  ...
  shared_examples_for 'a command with required aggregate_id and account_id' do
    it "should vlaidate presence aggregate_id and account_id" do
      subject = described_class.from_hash aggregate_id: nil, account_id: nil
