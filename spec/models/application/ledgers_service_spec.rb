...
RSpec.describe Application::LedgersService, :type => :model do
  ...
  describe "CreateNewAccount" do
    it "use the ledger to create the account" do
      cmd = i::LedgerCommands::CreateNewAccount.new ledger_id: 'ledger-1', 
  ...
  describe "CreateTag" do
    it "use the ledger to create tag and return it's id" do
      cmd = i::LedgerCommands::CreateTag.new ledger_id: 'ledger-1', name: 'tag-1', headers: dummy_headers
  ...
  describe "RenameTag" do
    it "use the ledger to rename tag" do
      cmd = i::LedgerCommands::RenameTag.new ledger_id: 'ledger-1', tag_id: 't-1', name: 'tag-1', headers: dummy_headers
      expect(repository).to get_by_id(Domain::Ledger, 'ledger-1').and_return(ledger1).and_save(with_dummy_headers)
  ...
  describe "RemoveTag" do
    it "use the ledger to remove tag" do
      cmd = i::LedgerCommands::RemoveTag.new ledger_id: 'ledger-1', tag_id: 't-1', headers: dummy_headers
      expect(repository).to get_by_id(Domain::Ledger, 'ledger-1').and_return(ledger1).and_save(with_dummy_headers)
  ...
  describe "CreateCategory" do
    it "use the ledger to create category and return it's id" do
      cmd = i::LedgerCommands::CreateCategory.new ledger_id: 'ledger-1', name: 'category-1', headers: dummy_headers
      expect(repository).to get_by_id(Domain::Ledger, 'ledger-1').and_return(ledger1).and_save(with_dummy_headers)
  ...
  describe "RenameCategory" do
    it "use the ledger to rename category" do
      cmd = i::LedgerCommands::RenameCategory.new ledger_id: 'ledger-1', category_id: 'c-1', name: 'category-1', headers: dummy_headers
      expect(repository).to get_by_id(Domain::Ledger, 'ledger-1').and_return(ledger1).and_save(with_dummy_headers)
  ...
  describe "RemoveCategory" do
    it "use the ledger to remove category" do
      cmd = i::LedgerCommands::RemoveCategory.new ledger_id: 'ledger-1', category_id: 'c-1', headers: dummy_headers
      expect(repository).to get_by_id(Domain::Ledger, 'ledger-1').and_return(ledger1).and_save(with_dummy_headers)
